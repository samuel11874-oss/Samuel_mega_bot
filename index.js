...
const app = express();
app.get('/', (req, res) => res.send('Bot Operacional - Leitura Direta'));
...
async function monitorarJogos() {
    try {
        ...
        // 1. Pega TODO o texto e transforma em uma "fita" limpa
        const fullText = $('body').text().replace(/\s+/g, ' ');
        
        // 2. Busca o padrão "Time x Time"
        // Regex: procura por nome de time (3 a 20 letras) + espaço + x + espaço + nome de time
        ...
        while ((match = regexJogo.exec(fullText)) !== null) {
            ...
            // 3. Pega o "trecho" de texto logo à frente para buscar os números
